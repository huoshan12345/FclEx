...
namespace FclEx.Slack.Extensions;

public static class SlackApiClientExtensions
{
    public static async Task<List<TResult>> PostChunked<TApi, TResult>(this TApi api, TableData tableData, Func<TApi, TableData, Task<TResult>> postFunc)
    {
