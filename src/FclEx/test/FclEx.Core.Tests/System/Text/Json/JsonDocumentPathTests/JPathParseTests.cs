...
public class JsonDocumentPathParseTests
{
    ...
    {
        var path = new JsonDocumentPath("[?(1 > 2)]");
    ...
    {
        var path = new JsonDocumentPath("Blah");
        Assert.Equal(1, path.Filters.Count);
    ...
    {
        var path = new JsonDocumentPath("['Blah.Ha']");
        Assert.Equal(1, path.Filters.Count);
    ...
    {
        var path = new JsonDocumentPath("$[1]");
        Assert.Equal(1, path.Filters.Count);
    ...
    {
        var path = new JsonDocumentPath("[ * ].derp");
    ...
    {
        var path = new JsonDocumentPath("$.elements[?(true)]");
        Assert.Equal(2, path.Filters.Count);
    ...
    {
        var path = new JsonDocumentPath("$.elements..[?(@.id=='AAA')]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("elements", ((FieldFilter)path.Filters[0]).Name);
    ...
    {
        var path = new JsonDocumentPath("Blah.Two");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
    ...
    {
        var path = new JsonDocumentPath("Blah[0]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
    ...
    {
        var path = new JsonDocumentPath("Blah[ ?( @..name ) ]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
    ...
    {
        var path = new JsonDocumentPath("Blah[ ?( @.name=='hi' ) ]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
    ...
    {
        var path = new JsonDocumentPath(@"Blah[ ?( @.name=='h\'i' ) ]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
        Assert.Equal(QueryOperator.Equals, expressions.Operator);
    ...
    {
        var path = new JsonDocumentPath("Blah[ ?( @.name=~/hi/i ) ]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
    ...
    {
        var path = new JsonDocumentPath("Blah[?(@.title =~ /^.*Sword.*$/)]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
        Assert.Equal(QueryOperator.RegexEquals, expressions.Operator);
    ...
    {
        var path = new JsonDocumentPath(@"Blah[?(@.title =~ /[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g)]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
        Assert.Equal(QueryOperator.RegexEquals, expressions.Operator);
    ...
    {
        var path = new JsonDocumentPath("Blah[ ?( @.name==false ) ]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
        Assert.Equal(QueryOperator.Equals, expressions.Operator);
    ...
    {
        var path = new JsonDocumentPath("Blah[ ?( @.name==true ) ]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
        Assert.Equal(QueryOperator.Equals, expressions.Operator);
    ...
    {
        var path = new JsonDocumentPath("Blah[ ?( @.name==null ) ]");
        Assert.Equal(2, path.Filters.Count);
        Assert.Equal("Blah", ((FieldFilter)path.Filters[0]).Name);
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[1]).Expression;
        Assert.Equal(QueryOperator.Equals, expressions.Operator);
    ...
    {
        var path = new JsonDocumentPath("[?(@..name<>null)]");
    ...
    {
        var path = new JsonDocumentPath("[?(@.name>=12)]");
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[0]).Expression;
    ...
    {
        var path = new JsonDocumentPath("[?(@.name>=12.1)]");
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[0]).Expression;
    ...
    {
        var path = new JsonDocumentPath("[?(@.name&&@.title)]");
    ...
    {
        var path = new JsonDocumentPath("[?(@.name&&@.title||@.pie)]");
    ...
    {
        var path = new JsonDocumentPath("[?(@.name>=5.56789e+0)]");
        var expressions = (BooleanQueryExpression)((QueryFilter)path.Filters[0]).Expression;
    ...
    {
        var path = new JsonDocumentPath("Blah[0]..Two.Three[1].Four");
    ...
    {
        var path = new JsonDocumentPath("[111119990]");
        Assert.Equal(1, path.Filters.Count);
    ...
    {
        var path = new JsonDocumentPath("[  10  ]");
        Assert.Equal(1, path.Filters.Count);
    ...
    {
        var path = new JsonDocumentPath("[111119990,3]");
        Assert.Equal(1, path.Filters.Count);
    ...
    {
        var path = new JsonDocumentPath("[111119990:3:2]");
        Assert.Equal(1, path.Filters.Count);
    ...
    {
        var path = new JsonDocumentPath("[  -3  :  ]");
        Assert.Equal(1, path.Filters.Count);
    ...
    {
        var path = new JsonDocumentPath("[1][0][0][" + int.MaxValue + "]");
    ...
    {
        var path = new JsonDocumentPath("frameworks.dnxcore50.dependencies.['System.Xml.ReaderWriter'].source");
