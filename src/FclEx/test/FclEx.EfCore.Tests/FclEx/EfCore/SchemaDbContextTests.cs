...
public class SchemaDbContextTests : IAssemblyFixture<GlobalFixture>
{
    private static async Task TestData(GlobalDbContext context)
    {
        var entity = new EntityWithAutoKey
        {
            Name = nameof(SchemaDbContext_Test),
            Value = 1,
        };
    ...
    [Fact]
    public async Task SchemaDbContext_Test()
    {
    ...
    [Fact]
    public async Task DbContext_WithoutSchema_Test()
    {
