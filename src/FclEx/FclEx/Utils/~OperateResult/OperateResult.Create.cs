...
namespace FclEx.Utils
{
    public partial struct OperateResult
    {
        ...
        public static OperateResult CreateSuccess(TimeSpan elapsed = default) => new(elapsed);

        public static OperateResult CreateError(int code, string? error, TimeSpan elapsed = default) => new(code, new SimpleException(error), elapsed);
