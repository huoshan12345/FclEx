...
- Comparers and comparer builders, including key/member comparers, delegate comparers, enumerable comparers, object-memory comparers, and equality-comparer builders.
