...
namespace FclEx.Http.HttpClientExt
{
    internal class DefaultHttpMessageHandlerFactory : IHttpMessageHandlerFactory
    {
        ...
        private Timer<DefaultHttpMessageHandlerFactory> _cleanupTimer;
        private readonly object _cleanupTimerLock = new object();
        private readonly object _cleanupActiveLock = new object();
        private readonly ILogger _logger;
        private readonly Func<HttpClientOptions, Lazy<ActiveHandlerTrackingEntry>> _entryFactory;
        ...
        private readonly ConcurrentDictionary<string, Lazy<ActiveHandlerTrackingEntry>> _activeHandlers
            = new ConcurrentDictionary<string, Lazy<ActiveHandlerTrackingEntry>>(StringComparer.Ordinal);
        ...
        private void ExpiryTimer_Tick(ActiveHandlerTrackingEntry active)
        {
