...
/// - The submission destination URI (equivalent to the 'action' attribute)
/// - The parameters/fields to be submitted with the form
/// </remarks>
...
{
    /// <summary>
    /// Gets or sets the destination URI where the form data will be submitted.
