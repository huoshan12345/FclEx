...
public class QueryExpressionTests
{
    ...
    {
        var e1 = new BooleanQueryExpression(QueryOperator.RegexEquals, new List<PathFilter>
        {
        ...
        var e2 = new BooleanQueryExpression(QueryOperator.RegexEquals, new List<PathFilter>
        {
            new ArrayIndexFilter()
    ...
    {
        var e1 = new BooleanQueryExpression(QueryOperator.LessThan, new List<PathFilter>
        {
            new ArrayIndexFilter()
        ...
        var e2 = new BooleanQueryExpression(QueryOperator.LessThanOrEquals, new List<PathFilter>
        {
            new ArrayIndexFilter()
        }, JsonDocument.Parse("3").RootElement);
    ...
    {
        var e1 = new BooleanQueryExpression(QueryOperator.GreaterThan, new List<PathFilter>
        {
            new ArrayIndexFilter()
        }, JsonDocument.Parse("3").RootElement);
    ...
    {
        var e1 = new BooleanQueryExpression(QueryOperator.GreaterThanOrEquals, new List<PathFilter>
        {
            new ArrayIndexFilter()
        }, JsonDocument.Parse("3").RootElement);
