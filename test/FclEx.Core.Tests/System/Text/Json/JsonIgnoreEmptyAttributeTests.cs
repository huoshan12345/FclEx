...
public class JsonIgnoreEmptyAttributeTests
{
    ...
    [Fact]
    public void Serialize_WithEmptyValues_ShouldIgnoreEmptyStringAndCollection_AttributeOnClass()
    {
    ...
    [Fact]
    public void Serialize_WithNonEmptyValues_ShouldIncludeNonEmptyProperties_AttributeOnClass()
    {
        var model = new SampleModel2
        {
            IgnoredEmptyString = "Not empty",
