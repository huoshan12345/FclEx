...
public partial class DbContextExtensionsTests(EfCoreFixture fixture) : EfCoreTests(fixture)
{
    ...
    public async Task SaveAsync_ShouldAddEntity_WhenIdIsDefault(DbProviderType dbProviderType)
    {
...

        {
            ...
            Assert.EqualToMilliseconds(entity.CreatedAt, updatedEntity.CreatedAt);
            Assert.EqualToMilliseconds(entity.UpdatedAt, updatedEntity.UpdatedAt);
        }
    }
    ...
    public async Task SaveAsync_ShouldModifyEntity_WhenIdIsNotDefault(DbProviderType dbProviderType)
    {
...

        {
            ...
            Assert.EqualToMilliseconds(createdAt, updatedEntity.CreatedAt);
            Assert.EqualToMilliseconds(entity.UpdatedAt, updatedEntity.UpdatedAt);
        }
    }
