...
public class HttpContentExtensionsTests
{
    ...
    {
        using var content = new StringContent("hello", Encoding.UTF8, MediaTypeNames.Text.Plain);
    ...
    {
        using var content = HttpContent.GZip("payload", MediaTypeNames.Application.Json);
